...
# Read input
raw_data = File.read('./day_2_input.txt')
games = raw_data.split("\n")

games.each { |game| scores << PART_1_GAME_RESULTS[game] }

p "Part 1 solution: #{scores.sum}" # 12458 is the correct answer for part 1
...
games.each { |game| scores << PART_2_GAME_RESULTS[game] }

p "Part 2 solution: #{scores.sum}" # 12683 is the correct answer for part 2
